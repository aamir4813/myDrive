...
# @login_required
# def dashboard():
#     return render_template("dashboard.html", title="Welcome", name=current_user.name, current_user=current_user)
...
def display_all():
    ...
    # print(data.fileName)
    return render_template("dashboard.html", title="Welcome", name=current_user.name, data=data, login = True)
